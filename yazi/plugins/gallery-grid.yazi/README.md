...
2. Press `ii` to open the gallery grid view
3. Use `in` to go to the next page of images
4. Use `ib` to go to the previous page of images
5. Use `i+` or `i-` to adjust the number of columns
