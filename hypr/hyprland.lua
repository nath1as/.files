...
hl.bind(mainMod .. " + R", hl.dsp.exec_cmd("hyprctl keyword monitor eDP-1,preferred,auto,2"))
...
-- Move windows with Super + Vim keys
...
-- Workspace scrolling and mouse dragging were disabled in the previous config.
